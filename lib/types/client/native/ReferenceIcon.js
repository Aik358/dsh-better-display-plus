...
import { IconFolder, IconRead } from '../icons.js';
/**
...
export function ReferenceIcon({ kind, size = 16, className }) {
    switch (kind) {
        ...
        case 'file': return _jsx(IconRead, { size: size, className: className });
        case 'folder': return _jsx(IconFolder, { size: size, className: className });
    }
}
