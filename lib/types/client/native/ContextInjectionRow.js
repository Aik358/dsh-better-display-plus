...
export function ContextInjectionRow({ content, source, provenance, producer, form, t }) {
    ...
    const view = producer ?? provenance ?? { role: 'inject', label: null };
    ...
    return (_jsx(DisclosureRow, { className: css.root, icon: view.role === 'recall'
            ...
            : _jsx(IconRead, { size: 14 }), chevronClassName: css.chevron, title: t(view.role === 'recall' ? 'message.contextRecall' : 'message.contextInjection'), collapsedContent: view.label === null ? undefined : (_jsxs(_Fragment, { children: [_jsx("span", { className: css.sep, "aria-hidden": true }), _jsx("span", { className: css.source, "data-context-source": true, children: view.label }), summary !== null && (_jsxs(_Fragment, { children: [_jsx("span", { className: css.sep, "aria-hidden": true }), _jsx("span", { className: css.summary, "data-context-summary": true, children: summary })] }))] })), keepContentWhenOpen: true, open: open, expandable: true, expandOnRowClick: true, onToggle: () => { setOpen(value => !value); }, children: _jsx("div", { className: css.body, "data-context-injection-body": true, "data-context-form": rendered ?? undefined, children: body }) }));
}
